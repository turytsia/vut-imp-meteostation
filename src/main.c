...
void app_main(void)
{
    ...
    ssd1306_display_text(&dev, 4, "Swipe to launch", 15, true);

    while (1) {
        // Poll for gesture data
        uint8_t prev_gesture = -1;
        uint8_t gesture;
        ...
        case APDS9960_UP:
            printf("Gesture: UP\n");
            ssd1306_display_text(&dev, 0, "Gesture: UP", 11, false);
            break;
        case APDS9960_DOWN:
            printf("Gesture: DOWN\n");
            ssd1306_display_text(&dev, 0, "Gesture: DOWN", 13, false);
            break;
        case APDS9960_LEFT:
            printf("Gesture: LEFT\n");
            ssd1306_display_text(&dev, 0, "Gesture: LEFT", 13, false);
            break;
        case APDS9960_RIGHT:
            printf("Gesture: RIGHT\n");
            ssd1306_display_text(&dev, 0, "Gesture: RIGHT", 14, false);
            break;
        default:
            printf("Gesture detected: %d\n", gesture);
            ssd1306_display_text(&dev, 0, "Gesture not detected", 21, false);
            break;
        }
